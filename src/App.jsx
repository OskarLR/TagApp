...
function App() {
  ...
  {id:2,name:"Emilie",email:"emiry@gmail.com",tagtime:"02:24:2",tagged:false, profilepicture:{profileicon}},
  {id:3,name:"Peder",email:"pedropa@gmail.com",tagtime:"01:02:57",tagged:false, profilepicture:{profileicon}},
  {id:4,name:"Axel",email:"axellag@gmail.com",tagtime:"18:12:21",tagged:false, profilepicture:{profileicon}},
  {id:5,name:"Brage",email:"gaute@gmail.com",tagtime:"12:01:33",tagged:false, profilepicture:{profileicon}}]
  ...
  return (
    <div className="App">
      ...
      <div id="content">
        ...
        <PlayerBoard players={players} setTagged={setTagged}></PlayerBoard>
      </div>
      <footer>
